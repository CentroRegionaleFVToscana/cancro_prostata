...
name_codelist[["med_diab"]] <- "Medicines contributing to the algorithm on diab and on antidiab(Table B of the protocol)"
...
name_codelist[["dia_ictus"]] <- "Diagnoses contributing to the algorithm on ictus and ictus_fup (Table B of the protocol)"
name_codelist[["dia_infart"]] <- "Diagnoses contributing to the algorithm on infart and infart_fup (Table B of the protocol)"
name_codelist[["dia_arit"]] <- "Diagnoses contributing to the algorithm on arit and arit_fup (Table B of the protocol)"
name_codelist[["dia_tia"]] <- "Diagnoses contributing to the algorithm on tia (Table B of the protocol)"
name_codelist[["dia_scompcard"]] <- "Diagnoses contributing to the algorithm on scompcard and scompcard_fup (Table B of the protocol)"
name_codelist[["dia_renal_fup"]] <- "Diagnoses contributing to the algorithm on renal_fup (Table B of the protocol)"
name_codelist[["dia_epa_fup"]] <- "Diagnoses contributing to the algorithm on epa_fup (Table B of the protocol)"
name_codelist[["dia_fratt_fup"]] <- "Diagnoses contributing to the algorithm on fratt_fup (Table B of the protocol)"
